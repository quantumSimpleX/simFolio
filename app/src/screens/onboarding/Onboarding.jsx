      ...
      {choices.map(({ title, termKey, desc }) => {
        ...
        return (
          <button
            ...
            className={cn(
              'flex min-h-[64px] w-full items-center rounded-card border-[1.5px] px-4 py-1.5 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ame-400',
