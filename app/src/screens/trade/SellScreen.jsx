...
import { StatusBar, GhostCTA, Eyebrow, TermUnderline } from '../../components/Primitives'
...
export default function SellScreen() {
  ...
  if (!pos) {
    return (
      <div style={{ width:390, minHeight:844, background:C.paper, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', gap:16 }}>
  ...
  return (
    <div style={{ width:390, minHeight:844, background:C.paper, display:'flex', flexDirection:'column' }}>
      ...
      <div style={{ padding:'14px 24px', borderBottom:`1px solid ${C.ink100}`, flexShrink:0, background:C.white }}>
      ...
      <div style={{ padding:'14px 24px 32px', borderTop:`1px solid ${C.ink100}`, flexShrink:0, display:'flex', flexDirection:'column', gap:10 }}>
