...
export const BADGES = [
  ...
  { id:'mentor',        name:'Mentored',            desc:'Choose your first hero mentor',              earned:false },
  { id:'steady',        name:'Steady Hand',         desc:'Hold through a 5%+ drop without selling',   earned:false },
  { id:'macro',         name:'Macro Thinker',       desc:'Ask your mentor about market conditions',   earned:false },
