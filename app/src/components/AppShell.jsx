...
// Responsive app chrome: top nav bar on tablet/desktop, and on mobile a fixed
// bottom region that is either the tab BottomNav or a screen-supplied `footer`
// (e.g. a Buy/Sell action bar on detail screens).
