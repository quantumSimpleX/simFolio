...
export function WatchRow({ sym, q, owned, onClick }) {
  return (
    <StockRow
      ...
      badge={owned && <div className="flex-shrink-0 rounded-[3px] border border-ame-100 bg-ame-50 px-1.5 py-px font-sans text-[10px] font-semibold text-ame-600">Owned</div>}
